...
const Header = ({ showSideMenuHandler }: Props) => (
    <header className='py-2 md:py-4 px-4 md:px-8 sticky top-0 bg-white	border-b border-solid border-[#3434341a]'>
        <div className='md:container md:mx-auto'>
            <div className="grid grid-cols-3 items-center block md:hidden">
                <button
                    className='w-fit'
                ...
                <div className='justify-self-center w-16 md:w-32 h-16 md:h-32 relative'>
                    <Image
            ...
            <div className='hidden md:inline-flex justify-between items-center w-full'>
                <div className='flex items-center gap-1'>
                    ...
                    <p className='font-semibold text-lg mt-1.5'>SHAWARMA SULTAN</p>
                </div>
                ...
                <div className='invisible md:visible inline-flex justify-end items-center gap-3 text-[#343434]'>
                    <span className="material-symbols-rounded text-4xl">person</span>
                    <span className="material-symbols-rounded text-4xl">shopping_basket</span>
                </div>
            </div>
