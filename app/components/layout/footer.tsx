...
const Footer = () => (
    <footer className="py-2 lg:py-6 px-4 lg:px-8 mt-20 bg-[#343434] text-white relative">
        ...
        <div className="lg:container lg:mx-auto grid grid-cols-3 gap-4 mt-12">
            <div>
                ...
                <ul className="flex items-center">
                    <li>
                        <Link href='https://www.instagram.com/sultanshawrma/' target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="45" height="45" viewBox="0,0,350,200"
                                style={{ fill: "#FFFFFF" }}>
                    ...
                    <li>
                        <Link href='https://www.tiktok.com/@sultan.shawrma' target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0,0,350,200"
                                style={{ fill: "#FFFFFF" }}>
